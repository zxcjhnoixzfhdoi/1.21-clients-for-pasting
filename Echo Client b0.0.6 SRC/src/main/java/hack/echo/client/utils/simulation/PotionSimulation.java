...
public class PotionSimulation implements Imports {
    ...
    public PotionSimulation(Vec3 position, Vec3 velocity) {
        this(position, velocity, mc.player);
    }

    public PotionSimulation(Vec3 position, Vec3 velocity, Entity sourceEntity) {
        this.position = position;
        this.velocity = velocity;
        this.sourceEntity = sourceEntity;
        this.ownerEntity = resolveOwner(sourceEntity);
