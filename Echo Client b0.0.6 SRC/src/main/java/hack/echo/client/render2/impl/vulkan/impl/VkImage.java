...
public class VkImage extends VkShader {
    ...
    protected VkGraphicsPipeline.Builder getPipelineBuilder() {
        return VkGraphicsPipeline.builder("2d/image/rounded_image.vert", "2d/image/rounded_image.frag")
                .stride(STRIDE)
